...
<p> <br/><br/><br>
<span class="stil2"><br/>
<span class="stil4">KASİYER</span></span></p>
<div id="apDiv10" >
  <table width="572" height="267" border="0">
    <tr>
      <td width="112"><div align="right"><span class="stil5">Ürün Ad:</span></div></td>
      <td width="300"> <form id="form1" name="form1" method="post" action="">
        <input type="text" name="urun_ad" id="urun_ad" />
         </form>  </td>
    </tr>
    <tr>
      <td><div align="right"><span class="stil5">Adet:</span></div></td>
      <td>
        <input type="text" name="urun_marka" id="urun_marka" />        </td>
    </tr>
    <tr>
      <td class="stil5"><div align="right">Fiyat:</div></td>
      <td>
        <input type="text" name="urun_fiyat" id="urun_fiyat" />       </td>
    </tr>
    <tr>
      <td colspan="2">
        
          <div align="left">
           <a href="giris.php"> <input type="submit" name="cikis" id="cikis" value=" Çıkış " src="yonetici.php"/></a>
            <input type="submit" name="s_ekle" id="s_ekle" value=" Satış " />
            <a href="fatura.php"><input type="submit" name="fatura" id="fatura" value=" Fatura Al " src="fatura.php" /></a>
          </div>
      </form>      </td>
      </tr>
  </table>
