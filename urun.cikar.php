...
<p> <br/><br/><br>
<span class="stil2"><br/>
<span class="stil4">ÜRÜN ÇIKAR</span></span></p>
<div id="apDiv10" >
  <table width="572" height="267" border="0">
    ...
    <tr>
      <td><div align="right"><span class="stil5">Marka:</span></div></td>
      <td>
    ...
    <tr>
      <td><div align="right"><span class="stil5">Stok:</span></div></td>
      <td>
        <input type="text" name="urun_stok" id="urun_stok" />          </td>
    </tr>
    <tr>
      <td colspan="2">
          ...
          <div align="left">
            ...
            <input type="submit" name="s_ekle" id="s_ekle" value="Ürün Çıkar" />
          </div>
      </form>      </td>
      </tr>
  </table>
